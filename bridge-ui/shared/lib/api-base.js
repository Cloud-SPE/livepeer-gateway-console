 ...
 * strategy and response-validator dispatcher. Ported from
 * livepeer-orch-coordinator's bridge-ui/shared/lib/api-base.js (which is
 * itself ported from openai-livepeer-bridge).
 *
 * @param {{
 *   baseUrl: string,
