...
export const EnvSchema = z.object({
  ...
  SENDER_SOCKET_PATH: z
    .string()
    .default("/var/run/livepeer/sender/payment.sock"),
  ...
  RESOLVER_AUDIT_POLL_INTERVAL_SEC: z.coerce
    .number()
    .int()
    .nonnegative()
    .default(30),
  ...
  MIN_BALANCE_WEI: z
    .string()
    .regex(/^[0-9]+$/, {
      message: "MIN_BALANCE_WEI must be a base-10 wei amount",
    })
    .optional(),
