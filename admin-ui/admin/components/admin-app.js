      ...
      <header class="app-bar">
        ...
        <nav style="display:flex; gap:1rem; margin-left:2rem;">
          <a
            href="#/routing"
            class=${this._path === "/" ||
            this._path.startsWith("/routing") ||
            this._path.startsWith("/orchs")
              ? "active"
              : ""}
            >Routing</a
          >
        ...
        >
          ${getActor()
            ? html`<span class="scope">actor: ${getActor()}</span>`
            : ""}
...
if (!customElements.get("admin-app"))
