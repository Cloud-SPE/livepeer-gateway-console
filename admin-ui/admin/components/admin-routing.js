...
export class AdminRouting extends LitElement {
  ...
  async _refreshAll() {
    ...
    if (!window.confirm("Refresh ALL orchs from chain? Idempotent but slow."))
      return;
                ...
                <table class="data">
                  ...
                  <tbody>
                    ${this._orchs.map(
                      (o) => html`
                        <tr
                          class=${this._selected === o.address
                            ? "selected"
                            : ""}
      ...
      <section class="card">
        <header class="card-header">
          ...
          <div>
            ...
            <button
              type="button"
              @click=${() => void this._refreshOne(this._selected)}
            >
              Refresh
            </button>
          </div>
        ...
        ${observations.length === 0
          ? html`<p class="muted">
              No observations yet. The poll worker hydrates these in the
              background.
            </p>`
          : html`
              <table class="data">
